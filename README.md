...
🌟 _Website theme [AstroWind](https://astro.build/blog/astro-2/)_. 🌟
...
> 🧑‍🚀 **Seasoned astronaut?** Delete this file. Update `config.js` and contents. Have fun!
...
Basic configuration file: `./src/config.js`
